...
function SaveTheDate() {
  return (
    <div className="save-the-date-content flex flex-col items-center justify-center">
      ...
      <img src={instax5} alt="instax5" className="drop-shadow-sm w-[90%] sm:w-3/4 pt-5 mb-5"/>
      <h3 className="text-center mb-5">
        <p className="font-semibold">Ceremony & Reception</p>
        <p className="text-(--foreground)">June 17, 2026</p>
      </h3>
      <h3 className="text-center mb-5">
        <p className="text-(--foreground) text-[18px] italic">For those invited to stay on-site:</p>
      ...
      <div className="italic text-center mb-5 w-[90%] sm:w-[90%]">
        <p className="mb-4">For those invited to <Link to="/travel">stay with us on-site</Link>, we hope you can join us for the <Link to="/schedule">full week</Link> (June 15-19), but if you can only attend a portion, please let us know when you RSVP.</p>
